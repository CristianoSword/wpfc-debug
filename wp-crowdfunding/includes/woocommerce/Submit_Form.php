...
class Submit_Form {
    ...
    function frontend_data_save(){
		...
		$show_apoiadores = get_option('wpcf_show_apoiadores', 'true');
		...
		$apoiadores = isset($_POST['wpneo-form-apoiadores']) ? sanitize_text_field($_POST['wpneo-form-apoiadores']) : '';
        ...
        if ($post_id) {
			...
			wpcf_function()->update_meta($post_id, 'wpneo_apoiadores', esc_attr($apoiadores));
