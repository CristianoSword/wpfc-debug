	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'    => array(
				...
				'placeholder' => __('A withdrawal request is received from your platform', 'wp-crowdfunding-pro'),
				'default'     => ''
			),
			'subject_for_campaign_owner'    => array(
				...
				'placeholder' => __('Congratulation, your withdrawal request has been submitted', 'wp-crowdfunding-pro'),
				'default'     => ''
			),
			'heading'    => array(
