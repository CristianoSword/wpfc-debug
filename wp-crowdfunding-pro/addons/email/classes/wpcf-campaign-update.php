	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'    => array(
				...
				'placeholder' => __('WP Crowdfunding Campaign [campaign_title] got update', 'wp-crowdfunding-pro'),
				'default'     => ''
			),
			...
			'heading'    => array(
				...
				'placeholder' => __('Campaign [campaign_title] got update', 'wp-crowdfunding-pro'),
				'default'     => ''
			),
