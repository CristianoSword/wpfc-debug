	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'    => array(
				...
				'placeholder' => __('WP Crowdfunding You have accepted a campaign', 'wp-crowdfunding-pro'),
				'default'     => ''
			),
			'subject_for_campaign_owner'    => array(
				...
				'placeholder' => __('Congratulation, your campaign has been approved', 'wp-crowdfunding-pro'),
				'default'     => ''
			),
			'heading'    => array(
